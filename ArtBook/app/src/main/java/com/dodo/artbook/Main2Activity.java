...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (info.matches("new")){
            ...
            artNameText.setText("Art Name");
            painterNameText.setText("Painter Name");
            yearText.setText("Year");
            button.setVisibility(View.VISIBLE);

            Bitmap selectedImage = BitmapFactory.decodeResource(getApplicationContext().getResources(),R.drawable.group5);
    ...
    public  Bitmap makeSmallerImage(Bitmap image , int maximumSize){
        ...
        return Bitmap.createScaledBitmap(image,witdh,height,true);
    }
}
